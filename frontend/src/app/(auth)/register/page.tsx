    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        try {
            const response = await axios.post(
                ...
                { email, password, fullname }, // Assuming you have a username in the registration form
                {
                    headers: {
            ...
            navigate.push("/login"); // Redirect to login page or wherever appropriate
        } catch (error) {
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Link href='/login'>
                    <div className='flex flex-row justify-center'>
                        <p className='font-normal text-[20px] leading-[24.2px] text-[#606060] '>Already have an account? <span className='text-[#0054A1]'>Log in</span>.</p>
                    </div>
                </Link>
            </div>
